...
if ((matricula!=null)&& (nome!=null)&& (dia!=null)&& (mes!=null)&& (ano!=null)&& (codDepartamento!=null)&& (titulacao!=null)){
    matricula = matricula.toUpperCase();
    nome = nome.toUpperCase();
    titulacao= titulacao.toUpperCase();
    ...
    if(contador==0){
        ...
        if (inserido){
          ...
          while (rs.next()){
             ...
             boolean inserido2 = dep.CriarProfessor(codDepartamento,titulacao,codPessoa);
             if (inserido2){   
                response.sendRedirect("cadastrarProfessor.jsp?msg=salvo");
             }else{ 
                response.sendRedirect("cadastrarProfessor.jsp?msg=erro");
             }    
          }
        }else{ 
          response.sendRedirect("cadastrarProfessor.jsp?msg=pessoa");
        }
    }else{
        response.sendRedirect("cadastrarProfessor.jsp?msg=contador");
    }  }
%>
