...
<script language="JavaScript">
    function Verifica(){
		...
		alert("Erro! Você deve digitar o nome ou parte do nome do autor desejado!");
...
<p align="left" class="titulo_form">Pesquisar monografia/projeto por autor
<hr align="left" class="titulo_form">
</p>
<form id="form1" name="form1" method="post" action="bibliPesquisarAutor.jsp" onsubmit="return Verifica(this)">
    ...
    <table width="97%" border="1" >
      <%
        if (nome!=null){
            ...
            ResultSet rs = biblio.BuscarBiblioAutor(nome);
    %>
      <tr>
