...
<p align="left" class="titulo_form">Cronograma do mês:
...
<table width="97%" border="1" >
  ...
  <% while(rs.next()){%>
  <tr>
    <td width="30%" class="letra_form"><a href="javascript:window.open('discCronAbrir.jsp?cod=<%=rs.getString("cod_cronograma")%> ','janela1','width=400,height=300,scrollbars=yes');void(null)"> <%=rs.getString("titulo_tarefa")%> </a></td>
...
<table>
  <tr>
    ...
    <td width="308" class="letra_form">Selecione outro mês desejado:
