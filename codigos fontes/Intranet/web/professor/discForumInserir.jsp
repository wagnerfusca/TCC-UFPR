...
<script language="JavaScript" type="text/JavaScript">
	...
	if(document.form1.conteudo.value==""){
		alert("Erro! O campo CONTEÚDO deve ser preenchido!");
...
<p align="left" class="titulo_form">Inserir tópico no fórum da disciplina
<hr align="left" class="titulo_form" />
</p>
<form id="form1" name="form1" method="post" action="salvadiscForumInserir.jsp" onSubmit="return Verifica(this)">
  <div>
    <div class="edit">
