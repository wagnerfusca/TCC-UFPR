...
<script language="JavaScript">
        function Atualizar()
        {
            document.form1.action="discCronEntregaAluno.jsp"
...
<%
   ...
   ResultSet rs = cronograma.BuscarTarefaAluno(dataInicio,dataFim,codDisciplinaVirtual);%>
<body class="fundo_cinza">
<p align="left" class="titulo_form">Visualizar tarefas entregues pelos alunos em:
  <%String nomeMes = cronograma.Mes(mes);%>
  <%=nomeMes%>/<%=ano1%>
...
<table width="97%" border="1" >
  ...
  <% while(rs.next()){%>
  <tr>
    <td width="30%" class="letra_form"><a href="javascript:window.open('discCronAbrir.jsp?cod=<%=rs.getString("cod_cronograma")%>&tipo=tarefaaluno','janela1','width=400,height=300,scrollbars=yes');void(null)"> <%=rs.getString("titulo_tarefa")%> </a></td>
...
<table>
  <tr>
    ...
    <td width="292" class="letra_form">Selecione outro mês desejado:
