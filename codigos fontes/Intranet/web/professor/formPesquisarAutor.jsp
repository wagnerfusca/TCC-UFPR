...
<script language="JavaScript" type="text/JavaScript">
       function Verifica(){
		...
		alert("Erro! Preencha o campo para a procura!");
...
<p align="left" class="titulo_form">Pesquisar documentos e formulários por autor
<hr align="left" class="titulo_form">
</p>
<form id="form1" name="form1" method="post" action="formPesquisarAutor.jsp" onsubmit="return Verifica(this)">
...
<table width="97%" border="1" >
  <% if (nome!=null){
        ...
        int destinatario = Integer.parseInt(codPessoa1);
            ...
            ResultSet rs = form.BuscarFormAutor(nome,destinatario);
            %>
  <tr>
