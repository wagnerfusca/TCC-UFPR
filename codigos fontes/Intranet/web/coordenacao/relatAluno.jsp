...
<p align="left" class="titulo_form">Relatório - Alunos Cadastrados
...
<div class="edit">
  ...
  <%Object codCoord=sessao.getAttribute("codCoord");
    ...
    ResultSet rs = coord.RelatorioAlunos(codCoordenacao);%>
    <tr>
      <td width="10%" class="letra_form">Cod: </td>
      <td width="30%" class="letra_form">Nome Aluno</td>
