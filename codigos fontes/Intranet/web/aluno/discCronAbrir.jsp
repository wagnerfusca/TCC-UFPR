...
<table>
     <tr>
        <td class="letra_form">Título: <%=rs.getString("titulo_tarefa") %> </td>
   </tr> 
<%if (tipo!=null) {%>
<tr>     <td width="10%" class="letra_form">Válido até:
   <%
...
<tr>    <td width="30%" class="letra_form">Inserido por:
   ...
   <tr>    <td class="letra_form">Conteúdo:<%=rs.getString("conteudo_tarefa") %></td>
   </tr> 
