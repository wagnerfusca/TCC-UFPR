...
<jsp:useBean id="edital" scope="page" class="Intranet.Edital" />
...
<p align="left" class="titulo_form">Pesquisar edital por data
<hr align="left" class="titulo_form">
</p>
<form id="form1" name="form1" method="post" action="editaisPesquisarData.jsp" onsubmit="return Verifica(this)">
	<p align="left" class="edit"><span class="letra_form">Pesquisar por:</span><br>
		Data Inicio: <input name="diainicio" type="text" class="input" id="diainicio" size="3" maxlength="2" />
		...
		<input name="pesquisar" type="submit" id="pesquisar" value="Pesquisar" /></p><br /><br />
	<div class="edit">
<table width="540" border="1" >

	<%
        if ((diainicio!=null) && (diafim!=null)){
            ResultSet rs = edital.BuscarEditalData(datainicio, datafim);
            %>
   <tr>
...
<%        while (rs.next()){%> 
   <tr>
         ...
         <a href="javascript:window.open('editalAbrir.jsp?cod=<%=rs.getString("cod_edital") %>','janela1','width=400,height=200,scrollbars=yes');void(null)"> 
<%=rs.getString("titulo_edital") %></a></td>
