...
<jsp:useBean id="link" scope="page" class="Intranet.Link" />
...
<a href="<%=rs.getString("endereco_links")%>" target="_blank" >Clique aqui</a>
        </td>
        <td width="40%" class="letra_form">
<%=rs.getString("conteudo_material")%>
</td>        
</td>
    </tr>
    <tr><td colspan="3"><hr></td></tr>
