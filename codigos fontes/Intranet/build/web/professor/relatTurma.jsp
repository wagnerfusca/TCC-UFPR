...
<p align="left" class="titulo_form">Relatório - Turmas que você irá dar aulas
...
<div class="edit">
  ...
  <%Object codProf=sessao.getAttribute("codProfessor");
    ...
    ResultSet rs = prof.RelatorioTurma(codProfessor);%>
    <tr>
      <td width="10%" class="letra_form">Cod: </td>
      <td width="20%" class="letra_form">Curso:</td>
      <td width="10%" class="letra_form">Turma:</td>
      <td width="20%" class="letra_form">Disciplina:</td>
      <td width="20%" class="letra_form">Professor: </td>
    ...
    <% while (rs.next()){%>
    <tr>
      <td width="10%" class="letra_form"><%=rs.getString("cod_turma") %></td>
      <td width="20%" class="letra_form"><%=rs.getString("nome_curso")%></td>
      <td width="10%" class="letra_form"><%=rs.getString("nome_turma")%></td>
