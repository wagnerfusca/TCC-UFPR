...
<script language="JavaScript">
            alert ("Edital não foi inserido ");
        </script>
<%   }else{%>
<script language="JavaScript">
             alert ("Edital inserido com sucesso");
        </script>
<% }
    } 
    %>
...
<p align="left" class="titulo_form">Inserir edital
<hr align="left" class="titulo_form" />
</p>
<form id="form1" name="form1" method="post" action="salvaEdital.jsp" onSubmit="return Verifica(this)">
  <div>
    <div class="edit">
