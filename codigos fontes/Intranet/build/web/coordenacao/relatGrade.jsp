...
<p align="left" class="titulo_form">Relatório - Grades Curriculares Cadastradas
...
<div class="edit">
  ...
  <%Object codCoord=sessao.getAttribute("codCoord");
    ...
    ResultSet rs = coord.RelatorioGrade(codCoordenacao);%>
    <tr>
      <td width="10%" class="letra_form">Cod: </td>
      <td width="30%" class="letra_form">Nome Grade</td>
      <td width="30%" class="letra_form">Curso </td>
      
    </tr>
    <% while (rs.next()){%>
    <tr>
      <td width="10%" class="letra_form"><%=rs.getString("cod_grade") %></td>
      <td width="30%" class="letra_form"><%=rs.getString("nome_grade")%></td>
