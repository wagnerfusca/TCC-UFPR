...
<p align="left" class="titulo_form">Relatório - Cursos Cadastrados
...
<div class="edit">
  ...
  <%Object codCoord=sessao.getAttribute("codCoord");
    ...
    ResultSet rs = coord.RelatorioCurso(codCoordenacao);%>
    <tr>
      <td width="10%" class="letra_form">Cod: </td>
      <td width="30%" class="letra_form">Nome Curso</td>
      <td width="30%" class="letra_form">Versão do curso </td>
      
    </tr>
    <% while (rs.next()){%>
    <tr>
      <td width="10%" class="letra_form"><%=rs.getString("cod_curso") %></td>
      <td width="30%" class="letra_form"><%=rs.getString("nome_curso")%></td>
       <td width="30%" class="letra_form"><%=rs.getString("cod_versao_curso")%></td>
