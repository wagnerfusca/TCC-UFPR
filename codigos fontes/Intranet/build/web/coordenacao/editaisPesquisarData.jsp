...
<form id="form1" name="form1" method="post" action="editaisPesquisarData.jsp" onsubmit="return Verifica(this)">
  ...
  <div class="edit">
    <table width="540" border="1" >
      ...
      <%        while (rs.next()){%>
      <tr>
        <td width="30%" class="letra_form"><a href="javascript:window.open('editalAbrir.jsp?cod=<%=rs.getString("cod_edital") %>','janela1','width=400,height=200,scrollbars=yes');void(null)"> <%=rs.getString("titulo_edital") %></a></td>
