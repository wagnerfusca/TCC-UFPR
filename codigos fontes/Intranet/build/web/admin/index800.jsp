...
<frameset rows="*" cols="172,*" frameborder="no" border="0" framespacing="0">
	<frameset rows="129,*" cols="*" framespacing="0" frameborder="no" border="0">
		...
		<frame src="frame_menu_admin.htm" name="frame_menu" scrolling="No" noresize="noresize" id="frame_menu" title="frame_menu" />
	</frameset>
	</frameset>
	<frameset rows="129,*" cols="*" framespacing="0" frameborder="no" border="0">
		...
		<frameset rows="66,*" cols="*" framespacing="0" frameborder="no" border="0">
			<frameset rows="*" cols="*,44" framespacing="0" frameborder="no" border="0">
		...
		<frameset rows="*" cols="*,44" framespacing="0" frameborder="no" border="0">
		<frame src="inicial.html" name="frame_main" id="frame_main" title="frame_main_dir" />
